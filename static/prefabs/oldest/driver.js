    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let [i, object] of data["items"].entries()) {
                ...
                trHTML += '<a href="/api_v2/prefabview?prefabId=' + object['id'] + '"><img src="/prefabs/tb/' + object['id'] + '/0" class="card-img-top" height="200px" alt="..." onerror="this.onerror=null;this.src=\'/content/default/forge.jpg\';"></a>';
